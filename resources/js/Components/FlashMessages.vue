  ...
  <div>
    ...
    >
      <div class="flex items-center">
        <svg
          class="flex-shrink-0 w-4 h-4 ml-4 mr-2 text-white fill-current"
      ...
      >
        <svg
          class="block w-2 h-2 fill-green-800 group-hover:text-white fill-current"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
    ...
    >
      ...
      >
        <svg
          class="block w-2 h-2 fill-red-800 group-hover:text-white fill-current"
          xmlns="http://www.w3.org/2000/svg"
          width="235.908"
          height="235.908"
          viewBox="278.046 126.846 235.908 235.908"
